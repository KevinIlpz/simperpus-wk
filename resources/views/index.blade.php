...
<body class="bg-gray-100">
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img src="{{ asset('images/logo.png') }}" alt="YourLogo" class="h-16 w-auto mr-2"
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center space-x-4">
                        <a href="#"
                            class="text-gray-800 hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Home</a>
                        <a href="#"
                            class="text-gray-800 hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Information</a>
                        <a href="#"
                            class="text-gray-800 hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition duration-300">News</a>
                        <a href="#"
                            class="text-gray-800 hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Help</a>
                        <a href="#"
                            class="text-gray-800 hover:bg-gray-200 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Librarian</a>
                        <a href="{{ route('login') }}">
                ...
                <div class="-mr-2 flex md:hidden">
                    <button type="button"
                        class="bg-gray-200 inline-flex items-center justify-center p-2 rounded-md text-gray-800 hover:text-gray-900 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-200 focus:ring-gray-500"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div class="mb-8">
            <div class="relative">
                <input type="text" placeholder="Enter keyword to search colletion..."
                    class="w-full p-4 pr-12 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    name="" id="">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md text-center">
                    <img src="{{ asset('images/social-sciences.png') }}" alt="Social Sciences"
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full lg:w-1/4 px-4">
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="font-semibold">Best Lending</h3>
                        <a href="#" class="text-sm text-indigo-500">VIEW ALL</a>
                    </div>
